...
public class RefactoredPlayerController : PlayerControllerBase
{
    ...
    protected override void SelectBullet(int index)
    {
        ...
        {   
            case 0:
                _pool = PoolRedBullet.Instance;
                break;

            case 1:
                _pool = PoolGreenBullet.Instance;
                break;

            case 2:
                _pool = PoolBlueBullet.Instance;
                break;
        }
    ...
    private void OnScoreChangeEvent(int scoreAdd) 
    {
        //no se pa que es esto
    }
